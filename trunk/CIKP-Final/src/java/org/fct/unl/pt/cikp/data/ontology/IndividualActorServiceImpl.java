...
public class IndividualActorServiceImpl implements IndividualActorService {
    ...
    public IndividualActor createActor(IndividualActor actor, PersistentOntology p) {
        try {
            ...
            onts.removeLiteralByProperty("has_Age", actor.getUsername(), p) ;
            onts.addLiteralByProperty("has_Age", actor.getUsername(), actor.getAge(), p);
            if (actor.getEmail_address() != null) {
                onts.removeLiteralByProperty("has_Email_Address", actor.getUsername(), p) ;
            ...
            if (actor.getFamily_name() != null) {
                onts.removeLiteralByProperty("has_Family_Name", actor.getUsername(), p) ;
            ...
            if (actor.getFax_number() != null) {
                onts.removeLiteralByProperty("has_Fax_Number", actor.getUsername(), p) ;
            ...
            if (actor.getGiven_name() != null) {
                onts.removeLiteralByProperty("has_Given_Name", actor.getUsername(), p) ;
            ...
            if (actor.getHome_phone_number() != null) {
                onts.removeLiteralByProperty("has_Home_Phone_Number", actor.getUsername(), p) ;
            ...
            if (actor.getMailing_address() != null) {
                onts.removeLiteralByProperty("has_Mailing_Address", actor.getUsername(), p) ;
            ...
            if (actor.getMiddle_name() != null) {
                onts.removeLiteralByProperty("has_Middle_Name", actor.getUsername(), p) ;
            ...
            if (actor.getMobile_phone_number() != null) {
                onts.removeLiteralByProperty("has_Mobile_Phone_Number", actor.getUsername(), p) ;
            ...
            if (actor.getName() != null) {
                onts.removeLiteralByProperty("has_Name", actor.getUsername(), p) ;
            ...
            if (actor.getWork_phone_number() != null) {
                onts.removeLiteralByProperty("has_Work_Phone_Number", actor.getUsername(), p) ;
            ...
            if (actor.getAbility() != null) {
                onts.removeLiteralByProperty("has_Ability", actor.getUsername(), p) ;
            ...
            if (actor.getCertificate_and_license() != null) {
                onts.removeLiteralByProperty("has_Certificate_And_License", actor.getUsername(), p) ;
            ...
            if (actor.getCommunication_language() != null) {
                onts.removeLiteralByProperty("has_Communication_Language", actor.getUsername(), p) ;
            ...
            if (actor.getEducation_background() != null) {
                onts.removeLiteralByProperty("has_Education_Background", actor.getUsername(), p) ;
            ...
            if (actor.getEthnicity() != null) {
                onts.removeLiteralByProperty("has_Ethnicity_Status", actor.getUsername(), p) ;
            ...
            if (actor.getExperience() != null) {
                onts.removeLiteralByProperty("has_Experience", actor.getUsername(), p) ;
            ...
            if (actor.getGender() != null) {
                onts.removeLiteralByProperty("has_Gender", actor.getUsername(), p) ;
            ...
            if (actor.getGeographic_affiliation() != null) {
                onts.removeLiteralByProperty("has_Geographic_Affiliation", actor.getUsername(), p) ;
            ...
            if (actor.getInformation_and_knowledge_need() != null) {
                onts.removeLiteralByProperty("has_Information_And_Knowledge_Need", actor.getUsername(), p) ;
            ...
            if (actor.getKnowledge() != null) {
                onts.removeLiteralByProperty("has_Knowledge", actor.getUsername(), p) ;
            ...
            if (actor.getMarital_status() != null) {
                onts.removeLiteralByProperty("has_Marital_Status", actor.getUsername(), p) ;
            ...
            if (actor.getSkill() != null) {
                onts.removeLiteralByProperty("has_Skill", actor.getUsername(), p) ;
            ...
            if (actor.getTraining_obtained() != null) {
                onts.removeLiteralByProperty("has_Training_Obtained", actor.getUsername(), p) ;
            ...
            if (actor.getCop_affiliation() != null) {
                onts.removeLiteralByProperty("has_COP_Affiliation", actor.getUsername(), p) ;
            ...
            if (actor.getOrganizational_affiliation() != null) {
                onts.removeLiteralByProperty("has_Organization_Affiliation", actor.getUsername(), p) ;
