    ...
    public Role createRole(Role role, PersistentOntology p) {
        try {
            ...
            if(role.getAuthority() != null) {
                onts.removeLiteralByProperty("has_Authority", role.getRoleentityname(), p) ;
            ...
            if(role.getEvent_affiliation() != null) {
                onts.removeLiteralByProperty("has_Event_Affiliation", role.getRoleentityname(), p) ;
            ...
            if(role.getExperience() != null) {
                onts.removeLiteralByProperty("has_Experience", role.getRoleentityname(), p) ;
            ...
            if(role.getInformation_and_knowledge_need() != null) {
                onts.removeLiteralByProperty("has_Information_And_Knowledge_Need", role.getRoleentityname(), p) ;
            ...
            if(role.getKnowledge() != null) {
                onts.removeLiteralByProperty("has_Knowledge", role.getRoleentityname(), p) ;
            ...
            if(role.getLiability() != null) {
                onts.removeLiteralByProperty("has_Liability", role.getRoleentityname(), p) ;
            ...
            if(role.getOrganizational_affiliation() != null) {
                onts.removeLiteralByProperty("has_Organization_Affiliation", role.getRoleentityname(), p) ;
            ...
            if(role.getProcess_affiliation() != null) {
                onts.removeLiteralByProperty("has_Process_Affiliation", role.getRoleentityname(), p) ;
            ...
            if(role.getProduct_affiliation() != null) {
                onts.removeLiteralByProperty("has_Product_Affiliation", role.getRoleentityname(), p) ;
            ...
            if(role.getProject_affiliation() != null) {
                onts.removeLiteralByProperty("has_Project_Affiliation", role.getRoleentityname(), p) ;
            ...
            if(role.getResponsibility() != null) {
                onts.removeLiteralByProperty("has_Responsibility", role.getRoleentityname(), p) ;
            ...
            if(role.getRight()!= null) {
                onts.removeLiteralByProperty("has_Right", role.getRoleentityname(), p) ;
                onts.addLiteralByProperty("has_Right", role.getRoleentityname(), role.getRight() == null ? "" : role.getRight(), p);
            }
            if(role.getSkill() != null) {
                onts.removeLiteralByProperty("has_Skill", role.getRoleentityname(), p) ;
            ...
            if(role.getTraining_obtained() != null) {
                onts.removeLiteralByProperty("has_Training_Obtained", role.getRoleentityname(), p) ;
