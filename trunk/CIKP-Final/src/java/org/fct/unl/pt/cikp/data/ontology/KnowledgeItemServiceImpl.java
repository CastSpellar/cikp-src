    ...
    public KnowledgeItem createKnowledgeItem(KnowledgeItem ki, PersistentOntology p) {
        try {
            ...
            if(ki.getKnowledge_item_author() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Author", kikey, p) ;
            ...
            if(ki.getKnowledge_item_composition_language() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Composition_Language", kikey, p) ;
            ...
            if(ki.getKnowledge_item_copyright_owner() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Copyright_Owner", kikey, p) ;
            ...
            if(ki.getKnowledge_item_creation_date() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Creation_Date", kikey, p) ;
            ...
            if(ki.getKnowledge_item_creation_time() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Creation_Time", kikey, p) ;
            ...
            if(Integer.toString(ki.getKnowledge_item_file_size()) != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_File_Size", kikey, p) ;
            ...
            if(ki.getKnowledge_item_file_type() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_File_Type", kikey, p) ;
            ...
            if(ki.getName() != null) {
                onts.removeLiteralByProperty("has_Name", kikey, p) ;
                onts.addLiteralByProperty("has_Name", kikey, ki.getName(), p);
            }
            if(ki.getKnowledge_item_security_clearance() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Security_Clearance", kikey, p) ;
            ...
            if(ki.getKnowledge_item_source() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Source", kikey, p) ;
            ...
            if(ki.getSubject_domain() != null) {
                onts.removeLiteralByProperty("has_Subject_Domain", kikey, p) ;
            ...
            if(ki.getKnowledge_item_type() != null) {
                onts.removeLiteralByProperty("has_Knowledge_Item_Type", kikey, p) ;
            ...
            if(ki.getEvent_affiliation() != null) {
                onts.removeLiteralByProperty("has_Event_Affiliation", kikey, p) ;
            ...
            if(ki.getGeographic_affiliation()!= null) {
                onts.removeLiteralByProperty("has_Geographic_Affiliation", kikey, p) ;
            ...
            if(ki.getProject_affiliation() != null) {
                onts.removeLiteralByProperty("has_Project_Affiliation", kikey, p) ;
