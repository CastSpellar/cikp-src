...
public class KnowledgeItemServiceImpl implements  KnowledgeItemService{
    ...
    public KnowledgeItem createKnowledgeItem(KnowledgeItem ki) {
        try {
            ...
            onts.addLiteralByProperty("has_Knowledge_Item_Author", kikey, (ki.getKnowledge_item_author() == null ? "" : ki.getKnowledge_item_author()));
            onts.addLiteralByProperty("has_Knowledge_Item_Composition_Language", kikey, (ki.getKnowledge_item_composition_language() == null ? "" : ki.getKnowledge_item_author()));
            onts.addLiteralByProperty("has_Knowledge_Item_Copyright_Owner", kikey, (ki.getKnowledge_item_copyright_owner() == null ? "" : ki.getKnowledge_item_copyright_owner()));
            onts.addLiteralByProperty("has_Knowledge_Item_Creation_Date", kikey, (ki.getKnowledge_item_creation_date() == null ? "" : ki.getKnowledge_item_creation_date()));
            onts.addLiteralByProperty("has_Knowledge_Item_Creation_Time", kikey, (ki.getKnowledge_item_creation_time() == null ? "" : ki.getKnowledge_item_creation_time()));
            onts.addLiteralByProperty("has_Knowledge_Item_Destination", kikey, (ki.getKnowledge_item_destination() == null ? "" : ki.getKnowledge_item_destination()));
            onts.addLiteralByProperty("has_Knowledge_Item_File_Size", kikey, ki.getKnowledge_item_file_size());
            onts.addLiteralByProperty("has_Knowledge_Item_File_Type", kikey, (ki.getKnowledge_item_file_type() == null ? "" : ki.getKnowledge_item_file_type()));
            ...
            onts.addLiteralByProperty("has_Knowledge_Item_Security_Clearance", kikey, (ki.getKnowledge_item_security_clearance() == null ? "" : ki.getKnowledge_item_security_clearance()));
            onts.addLiteralByProperty("has_Knowledge_Item_Source", kikey, (ki.getKnowledge_item_source() == null ? "" : ki.getKnowledge_item_source()));
            onts.addLiteralByProperty("has_Subject_Domain", kikey, (ki.getSubject_domain() == null ? "" : ki.getSubject_domain()));
            onts.addLiteralByProperty("has_Knowledge_Item_Type", kikey, (ki.getKnowledge_item_type() == null ? "" : ki.getKnowledge_item_type()));
            onts.addLiteralByProperty("has_Event_Affiliation", kikey, (ki.getEvent_affiliation() == null ? "" : ki.getEvent_affiliation()));
            onts.addLiteralByProperty("has_Geographic_Affiliation", kikey, (ki.getGeographic_affiliation() == null ? "" : ki.getGeographic_affiliation()));
            onts.addLiteralByProperty("has_Product_Affiliation", kikey, (ki.getProduct_affiliation() == null ? "" : ki.getProduct_affiliation()));
            onts.addLiteralByProperty("has_Project_Affiliation", kikey, (ki.getProject_affiliation() == null ? "" : ki.getProject_affiliation()));
            return ki;
    ...
    public KnowledgeItem getKnowledgeItem(String entityname) {
        ...
        try {
            ...
            item.setKnowledge_item_creation_date((XSDDateType)onts.getLiteralByProperty(entityname, "has_Knowledge_Item_Creation_Date"));
            item.setKnowledge_item_creation_time((XSDTimeType)onts.getLiteralByProperty(entityname, "has_Knowledge_Item_Creation_Time"));
